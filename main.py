...
json_file = f"{project_dir}/sources/verses_data/relationships.json"
fonts_dir = f"{project_dir}/sources/fonts"
output_folder = f"{project_dir}/customers"
text_source_font = f"{project_dir}/sources/MouldyCheeseRegular-WyMWG.ttf"
...
fonts_paths = [
    f"{project_dir}/sources/fonts/CoffeeJellyUmai.ttf",
    f"{project_dir}/sources/fonts/CourierprimecodeRegular.ttf",
    f"{project_dir}/sources/fonts/FlowersSunday.otf",
    f"{project_dir}/sources/fonts/GreenTeaJelly.ttf",
    f"{project_dir}/sources/fonts/HeyMarch.ttf",
    f"{project_dir}/sources/fonts/LetsCoffee.otf",
    f"{project_dir}/sources/fonts/LikeSlim.ttf",
    f"{project_dir}/sources/fonts/SunnySpellsBasicRegular.ttf",
    f"{project_dir}/sources/fonts/TakeCoffee.ttf",
    f"{project_dir}/sources/fonts/WantCoffee.ttf",
]
